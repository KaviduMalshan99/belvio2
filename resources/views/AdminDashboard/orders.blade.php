...
<ul class="nav nav-tabs mb-3" id="orderTabs" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request('status') === 'Pending' ? 'active' : '' }}" href="{{ route('orders', ['status' => 'Pending']) }}">Pending Orders</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ request('status') === 'Accepted' ? 'active' : '' }}" href="{{ route('orders', ['status' => 'Accepted']) }}">Accepted Orders</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ request('status') === 'Packed' ? 'active' : '' }}" href="{{ route('orders', ['status' => 'Packed']) }}">Packed Orders</a>
    </li>
</ul>
