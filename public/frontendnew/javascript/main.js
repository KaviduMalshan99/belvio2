        ...
        $(window).on('load resize', function() {
            ...
            if (currMenuType !== menuType) {
                ...
                if (currMenuType === 'mobile') {
                    ...
                    // Append user-related icons (profile, wishlist, cart) to the mobile menu dynamically
                    var mobileExtras = `
                    <ul class="menu">
                        ${userLoggedIn ? `
                        <li class="box-login">
                            <a href="/user-profile" class="icon_login nav-cart-trigger active">
                                <span class="fs-2">${userName}</span> - Profile
                            </a>
                        </li>` : `
                        <li class="box-login">
                            <a class="icon_login active" href="/cus-login">Login</a>
                        </li>`}

                        ${userLoggedIn ? `
                        <li class="box-cart nav-top-cart-wrapper">
                            <a class="icon_heart nav-cart-trigger active" href="/wishlist">
                                Wishlist
                            </a>
                        </li>` : ``}
                ...
                `;
                    ...
                    $('#mainnav-mobi').append(mobileExtras);
